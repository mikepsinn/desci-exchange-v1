...
export default function Info(props) {
  ...
  const fixedSocialMediaUrl = socialMediaUrl.includes('http')
    ? ''
        ...
        <Grid item className={classes.rightAlignedText}>
          {!previewMode ? (
            <Grid container alignItems="center">
              <Grid item>
                <div className="lds-ripple" id="loadingSpinner">
                  <div />
                  <div />
                </div>
              </Grid>
          ...
          <div style={{ height: 1 }} />
          {socialMediaUrl ? (
            <Link href={fixedSocialMediaUrl} target="_blank" rel="noreferrer">
              {socialMediaUrl}
            </Link>
          ) : null}
          <div style={{ height: 8 }} />
