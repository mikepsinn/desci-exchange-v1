...
export function updateDataSourceButtonLink(button: {
  link: string | URL;
}): void {
  if (!button.link) {
    return;
...
export const getDataSources = async (): Promise<DataSource[]> => {
  return getRequest('/api/v3/connectors/list', {
...
function makeQueryIds() {
  return {
    ...
    getMeasurements: (id?: number) =>
      ['getMeasurements', nullIfUndefined(id)] as const,
    ...
    getCorrelations: (commonOnly?: boolean) =>
      ['getCorrelations', nullIfUndefined(commonOnly)] as const,
    ...
    getTrackingReminderNotifications: () =>
      ['getTrackingReminderNotifications'] as const,
  ...
  return {
      ...
      axios
        .request<UserVariable[]>({
          ...
          params: {
            ...
            ...(parentUserTagVariableId !== undefined
              ? { parentUserTagVariableId }
              : undefined),
            ...(childUserTagVariableId !== undefined
              ? { childUserTagVariableId }
              : undefined),
            ...(ingredientUserTagVariableId !== undefined
              ? { ingredientUserTagVariableId }
              : undefined),
            ...(ingredientOfUserTagVariableId !== undefined
    ...
    getConnectors: () =>
      axios
        ...
        .then((res) => res.data),
    connectConnector: (
      connectorName: QueryFunctionContext<readonly [string]>
    ) =>
      axios
        .request<unknown>({
          method: 'get',
    ...
    postTrackingReminderNotifications: (
      payload: TrackingReminderNotificationPost[]
    ) =>
      axios
        .request<CommonResponse>({
          method: 'post',
...
function makeQueries(
  ...
  return {
    ...
    > =>
      useQuery(
        queryIds.getMeasurements(id),
        () => requests.getMeasurements(id),
        options
      ),
    useGetAppSettings: (
      options?: Omit<
    ...
    > =>
      useQuery(
        queryIds.getAppSettings(),
        () => requests.getAppSettings(),
        options
      ),
    ...
    > =>
      useQuery(
        queryIds.getMobileConnectPage(),
        () => requests.getMobileConnectPage(),
        options
      ),
    useGetConnectors: (
      options?: Omit<
    ...
    > =>
      useQuery(
        queryIds.getConnectors(),
        () => requests.getConnectors(),
        options
      ),
    useConnectConnector: (
      options?: Omit<
    ...
    > =>
      useQuery(
        queryIds.connectConnector(),
        (connectorName) => requests.connectConnector(connectorName),
        options
      ),
    ...
    > =>
      useQuery(
        queryIds.disconnectConnector(),
        (connectorName) => requests.disconnectConnector(connectorName),
        options
      ),
    useUpdateConnector: (
      options?: Omit<
    ...
    > =>
      useQuery(
        queryIds.updateConnector(),
        (connectorName) => requests.updateConnector(connectorName),
        options
      ),
    useGetCorrelations: (
      commonOnly?: boolean,
    ...
    > =>
      useQuery(
        queryIds.getCorrelations(commonOnly),
        () => requests.getCorrelations(commonOnly),
        options
      ),
    useGetFeed: (
      options?: Omit<
    ...
    > =>
      useQuery(
        queryIds.getIntegrationJs(),
        () => requests.getIntegrationJs(),
        options
      ),
    ...
    > =>
      useQuery(
        queryIds.getNotificationPreferences(),
    ...
    > =>
      useQuery(
        queryIds.getOauthAuthorizationCode(),
        () => requests.getOauthAuthorizationCode(),
        options
      ),
    useGetAccessToken: (
      options?: Omit<
    ...
    > =>
      useQuery(
        queryIds.getOpenStudies(),
        () => requests.getOpenStudies(),
        options
      ),
    useGetStudiesJoined: (
      options?: Omit<
    ...
    > =>
      useQuery(
        queryIds.getStudiesJoined(),
        () => requests.getStudiesJoined(),
        options
      ),
    ...
    > =>
      useQuery(
        queryIds.getStudiesCreated(),
        () => requests.getStudiesCreated(),
        options
      ),
    ...
    > =>
      useQuery(
        queryIds.getTrackingReminderNotifications(),
        () => requests.getTrackingReminderNotifications(),
        options
      ),
    ...
    > =>
      useQuery(
        queryIds.getUnitCategories(),
        () => requests.getUnitCategories(),
        options
      ),
    useGetUser: (
      options?: Omit<
    ...
    > =>
      useQuery(
        queryIds.getVariableCategories(),
        () => requests.getVariableCategories(),
        options
      ),
    useGetStudy: (
      options?: Omit<
...
type MutationConfigs = {
  ...
  useMeasurementExportRequest?: (
    ...
    UseMutationOptions<
      Awaited<
        ReturnType<ReturnType<typeof makeRequests>['measurementExportRequest']>
      >,
      unknown,
      unknown,
      unknown
  ...
  useDeleteShare?: (
    ...
    UseMutationOptions<
      Awaited<ReturnType<ReturnType<typeof makeRequests>['deleteShare']>>,
      unknown,
      unknown,
      unknown
    >,
  ...
  usePublishStudy?: (
    ...
    UseMutationOptions<
      Awaited<ReturnType<ReturnType<typeof makeRequests>['publishStudy']>>,
      unknown,
      unknown,
      unknown
    >,
  ...
  useJoinStudy?: (
    ...
    UseMutationOptions<
      Awaited<ReturnType<ReturnType<typeof makeRequests>['joinStudy']>>,
      unknown,
      unknown,
      unknown
    >,
  ...
  usePostTrackingReminderNotifications?: (
    ...
    UseMutationOptions<
      Awaited<
        ReturnType<
          ReturnType<typeof makeRequests>['postTrackingReminderNotifications']
        >
      >,
      unknown,
      Parameters<
  ...
  usePostTrackingReminders?: (
    ...
    UseMutationOptions<
      Awaited<
        ReturnType<ReturnType<typeof makeRequests>['postTrackingReminders']>
      >,
      unknown,
  ...
  useDeleteTrackingReminder?: (
    ...
    UseMutationOptions<
      Awaited<
        ReturnType<ReturnType<typeof makeRequests>['deleteTrackingReminder']>
      >,
      unknown,
      unknown,
      unknown
  ...
  useDeleteUser?: (
    ...
    UseMutationOptions<
      Awaited<ReturnType<ReturnType<typeof makeRequests>['deleteUser']>>,
      unknown,
      unknown,
      unknown
    >,
  ...
  useDeleteUserVariable?: (
    ...
    UseMutationOptions<
      Awaited<
        ReturnType<ReturnType<typeof makeRequests>['deleteUserVariable']>
      >,
      unknown,
      unknown,
      unknown
  ...
  useResetUserVariableSettings?: (
    ...
    UseMutationOptions<
      Awaited<
        ReturnType<ReturnType<typeof makeRequests>['resetUserVariableSettings']>
      >,
      unknown,
      Parameters<
        ReturnType<typeof makeRequests>['resetUserVariableSettings']
      >[0],
      unknown
    >,
    'onSuccess' | 'onSettled' | 'onError'
  ...
  useDeleteVote?: (
    ...
    UseMutationOptions<
      Awaited<ReturnType<ReturnType<typeof makeRequests>['deleteVote']>>,
      unknown,
      unknown,
      unknown
    >,
  ...
  return {
    usePostUserVariables: (
      ...
      useRapiniMutation<
        ...
        Parameters<typeof requests.postUserVariables>[0]
      >(
        (payload) => requests.postUserVariables(payload),
        config?.usePostUserVariables,
        options
      ),
    usePostMeasurements: (
      options?: Omit<
      ...
      useRapiniMutation<
        ...
        Parameters<typeof requests.postMeasurements>[0]
      >(
        (payload) => requests.postMeasurements(payload),
        config?.usePostMeasurements,
        options
      ),
    useUpdateMeasurement: (
      options?: Omit<
      ...
      useRapiniMutation<
        ...
        Parameters<typeof requests.updateMeasurement>[0]
      >(
        (payload) => requests.updateMeasurement(payload),
        config?.useUpdateMeasurement,
        options
      ),
    useDeleteMeasurement: (
      options?: Omit<
        UseMutationOptions<
          Awaited<ReturnType<typeof requests.deleteMeasurement>>,
          unknown,
          unknown,
          unknown
        >,
    ...
    useMeasurementExportRequest: (
      options?: Omit<
        UseMutationOptions<
          Awaited<ReturnType<typeof requests.measurementExportRequest>>,
          unknown,
          unknown,
          unknown
        >,
    ...
    usePostDeviceToken: (
      ...
      useRapiniMutation<
        ...
        Parameters<typeof requests.postDeviceToken>[0]
      >(
        (payload) => requests.postDeviceToken(payload),
        config?.usePostDeviceToken,
        options
      ),
    usePostFeed: (
      options?: Omit<
    ...
    useDeleteShare: (
      ...
      options?: Omit<
        UseMutationOptions<
          Awaited<ReturnType<typeof requests.deleteShare>>,
          unknown,
          unknown,
          unknown
        >,
    ...
    useInviteShare: (
      ...
      useRapiniMutation<
        ...
        Parameters<typeof requests.inviteShare>[0]
      >(
        (payload) => requests.inviteShare(payload),
        config?.useInviteShare,
        options
      ),
    usePublishStudy: (
      options?: Omit<
        UseMutationOptions<
          Awaited<ReturnType<typeof requests.publishStudy>>,
          unknown,
          unknown,
          unknown
        >,
      ...
      useRapiniMutation<
        ...
        unknown,
        unknown
      >(() => requests.publishStudy(), config?.usePublishStudy, options),
    useJoinStudy: (
      options?: Omit<
        UseMutationOptions<
          Awaited<ReturnType<typeof requests.joinStudy>>,
          unknown,
          unknown,
          unknown
        >,
      ...
      useRapiniMutation<
        ...
        unknown,
        unknown
      >(() => requests.joinStudy(), config?.useJoinStudy, options),
    useCreateStudy: (
      options?: Omit<
        UseMutationOptions<
      ...
      useRapiniMutation<
        ...
        Parameters<typeof requests.createStudy>[0]
      >(
        (payload) => requests.createStudy(payload),
        config?.useCreateStudy,
        options
      ),
    usePostTrackingReminderNotifications: (
      options?: Omit<
        UseMutationOptions<
          Awaited<
            ReturnType<typeof requests.postTrackingReminderNotifications>
          >,
          unknown,
    ...
    usePostTrackingReminders: (
      ...
      useRapiniMutation<
        ...
        Parameters<typeof requests.postTrackingReminders>[0]
      >(
        (payload) => requests.postTrackingReminders(payload),
        config?.usePostTrackingReminders,
        options
      ),
    useDeleteTrackingReminder: (
      options?: Omit<
    ...
    useDeleteUser: (
      ...
      options?: Omit<
        UseMutationOptions<
          Awaited<ReturnType<typeof requests.deleteUser>>,
          unknown,
          unknown,
          unknown
        >,
      ...
      useRapiniMutation<
        ...
        unknown,
        unknown
      >(() => requests.deleteUser(reason), config?.useDeleteUser, options),
    usePostUserSettings: (
      options?: Omit<
        UseMutationOptions<
      ...
      useRapiniMutation<
        ...
        Parameters<typeof requests.postUserSettings>[0]
      >(
        (payload) => requests.postUserSettings(payload),
        config?.usePostUserSettings,
        options
      ),
    usePostUserTags: (
      options?: Omit<
      ...
      useRapiniMutation<
        ...
        Parameters<typeof requests.postUserTags>[0]
      >(
        (payload) => requests.postUserTags(payload),
        config?.usePostUserTags,
        options
      ),
    useDeleteUserTag: (
      options?: Omit<
        UseMutationOptions<
          Awaited<ReturnType<typeof requests.deleteUserTag>>,
          unknown,
          unknown,
          unknown
        >,
      ...
      useRapiniMutation<
        ...
        unknown,
        unknown
      >(() => requests.deleteUserTag(), config?.useDeleteUserTag, options),
    useDeleteUserVariable: (
      options?: Omit<
        UseMutationOptions<
          Awaited<ReturnType<typeof requests.deleteUserVariable>>,
          unknown,
          unknown,
          unknown
        >,
    ...
    useResetUserVariableSettings: (
      ...
      useRapiniMutation<
        ...
        Parameters<typeof requests.resetUserVariableSettings>[0]
      >(
        (payload) => requests.resetUserVariableSettings(payload),
        config?.useResetUserVariableSettings,
        options
      ),
    usePostVote: (
      options?: Omit<
    ...
    useDeleteVote: (
      options?: Omit<
        UseMutationOptions<
          Awaited<ReturnType<typeof requests.deleteVote>>,
          unknown,
          unknown,
          unknown
        >,
      ...
      useRapiniMutation<
        ...
        unknown,
        unknown
      >(() => requests.deleteVote(), config?.useDeleteVote, options),
  } as const;
}
...
export async function findVariableCategory(
  nameOrId: string
  ...
  return cats.find(function (cat: {
    ...
    return (
      cat.id === nameOrId ||
      cat.name === nameOrId ||
      cat.synonyms.indexOf(nameOrId) > -1
    );
  });
}
...
export function calculateVariableScore(uv: UserVariable): number | null {
  ...
  return (
    ((uv.lastValue - uv.minimumRecordedValue) /
      (uv.maximumRecordedValue - uv.minimumRecordedValue)) *
    100
  );
}
...
export async function mintNFTForUserVariable(
  userVariable: UserVariable,
  recipientAddress: string,
  chainNameLowercase: string
): Promise<any> {
  ...
  const options = {
    ...
    params: {
      ...
      file_url: getApiUrl('/api/v3/variables', {
...
async function addBackgroundImage(canvas: Canvas, backgroundImg?: string) {
  if (!backgroundImg) {
    backgroundImg =
      'https://static.quantimo.do/humanfs/human-fs-nft-background.png';
  }
...
export async function generateLifeForceNftImage(
  backgroundImg: string | undefined
): Promise<string> {
  const canvas = createCanvas(width, height);
  const context = await addBackgroundImage(canvas, backgroundImg);
 ...
 * @param {string} chainNameLowercase The chain that was minted on. "ethereum" and "polygon" are currently supported.
 * @param {UserVariable} userVariable The account address to check
 * @returns {Promise} The token ids owned by the accountAddress
 */
export async function encryptUserVariableToNft(
  chainNameLowercase: string,
  userVariable: UserVariable
) {
  ...
  //     showNotification('SAFE_NFT_MINTED))
  //   })
  //   .catch(function (error) {
  //     showNotification('SAFE_NFT_ERROR))
  //     debugger
  ...
  const lockedFileMediaGridHtml = await fetch(userVariable.url).then((r) =>
    r.text()
  );
  ...
  const htmlString = await createHtmlWrapper({
    title: userVariable.name,
    description: userVariable.description,
    quantity: 1,
    socialMediaUrl: userVariable.url,
  ...
  console.log('Uploading html data to IPFS');
  const gottenFileUrl = await uploadToIPFS(htmlString);
  console.log('SAFE_NFT_MINTED');
  return gottenFileUrl;
}

async function uploadToIPFS(htmlString: string) {
